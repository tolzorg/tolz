  ...
  },
  {
    ...
    calculators: [
      ...
      },
      {
        ...
        description:
          "Calculate your monthly auto loan payment including sales tax, trade-in credit, cash incentives, and title/registration fees. Solve for price or payment, and view a full amortization schedule.",
        icon: "🚗",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/auto-loan-calculator",
        legacyPath: "/tools/auto-loan-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Calculate the monthly payment for a fixed-term loan, or the time it takes to pay off a loan with a fixed monthly payment. View a full annual or monthly amortization schedule.",
        icon: "💳",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/payment-calculator",
        legacyPath: "/tools/payment-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Estimate how much you need to retire, build a savings plan to get there, project a sustainable withdrawal amount, and see how long your savings can last.",
        icon: "🏖️",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/retirement-calculator",
        legacyPath: "/tools/retirement-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Find out how much rent you can afford based on your gross income and existing monthly debt, using the same 28%/36% debt-to-income guidelines lenders use for mortgages.",
        icon: "🏠",
        iconBg: "#eff6ff",
        iconColor: "#2563eb",
        path: "/calculators/financial/rent-calculator",
        legacyPath: "/tools/rent-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Estimate the financial impact of filing a joint tax return as a married couple vs. each spouse filing on their own pre-marriage status, based on U.S. federal income tax brackets.",
        icon: "💍",
        iconBg: "#fdf2f8",
        iconColor: "#db2777",
        path: "/calculators/financial/marriage-tax-calculator",
        legacyPath: "/tools/marriage-tax-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Solve for future value, payment, interest rate, number of periods, or present value, the same 5-key time-value-of-money calculation used by a BA II Plus or HP 12C.",
        icon: "🧮",
        iconBg: "#fdf4ff",
        iconColor: "#a21caf",
        path: "/calculators/financial/finance-calculator",
        legacyPath: "/tools/finance-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "See how extra payments or biweekly payments can shorten your mortgage and save on interest, or find out exactly what it costs to pay off your loan today.",
        icon: "🏁",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/mortgage-payoff-calculator",
        legacyPath: "/tools/mortgage-payoff-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Compare or convert an interest rate between different compounding frequencies, annually, monthly, daily, continuously, and more.",
        icon: "🔁",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/compound-interest-calculator",
        legacyPath: "/tools/compound-interest-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Convert a salary between hourly, daily, weekly, biweekly, semi-monthly, monthly, quarterly, and annual pay, with figures both before and after holidays and vacation.",
        icon: "💵",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/salary-calculator",
        legacyPath: "/tools/salary-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Estimate a 401(k) balance at retirement and withdrawals afterward, plus early withdrawal costs and the contribution percentage that maximizes your employer match.",
        icon: "🏦",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/401k-calculator",
        legacyPath: "/tools/401k-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Solve for any one of before-tax price, sales tax rate, or after-tax price, given the other two.",
        icon: "🧾",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/sales-tax-calculator",
        legacyPath: "/tools/sales-tax-calculator",
        keywords: [
      ...
      },
      {
        ...
        description:
          "Estimate an affordable house purchase amount based on household income, debts, and lending guidelines (Conventional, FHA, VA), or a fixed monthly budget.",
        icon: "🏠",
        iconBg: "#f0fdf4",
        iconColor: "#16a34a",
        path: "/calculators/financial/house-affordability-calculator",
        legacyPath: "/tools/house-affordability-calculator",
        keywords: [
