...
export const TOOL_CATEGORY_PAGES = [
  ...
  },
  {
    ...
    name: "Text Tools",
    tagline: "Count words, characters, and reading time instantly — free, no signup.",
    icon: "📝",
    iconBg: "#fefce8",
    iconColor: "#ca8a04",
    seoTitle: "Free Word Counter Online – Words, Characters & More",
    seoDescription:
      "Count words, characters, sentences, and reading time instantly. Upload .txt or .md files. Free online word counter, no signup required.",
    introHeading: "Analyze Your Text in Seconds",
    introParagraphs: [
      "Whether you're hitting a word count requirement for an essay, checking a social media caption's character limit, or estimating how long an article takes to read, Tolz's Word Counter gives you the numbers instantly. Paste text directly or upload a .txt or .md file to get word count, character count, sentence and paragraph counts, and estimated reading time.",
      "Everything is calculated in your browser, with nothing uploaded to a server.",
    ],
    benefitsHeading: "Why Use Tolz's Text Tools",
    benefits: [
      { title: "Meet exact limits", text: "Track word and character counts for essays, ads, captions, and forms." },
      { title: "File upload support", text: "Analyze .txt and .md files directly — no copy-pasting required." },
