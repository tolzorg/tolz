...
/** Hand-rolled SVG line chart for the "Loan Amortization Graph" — three
 * series plotted against loan year: the declining remaining balance
 * (starting at `loanAmount`), and the two RUNNING TOTALS (cumulative
 * interest paid, cumulative total payments made, both starting at $0) —
 * matching the reference's own chart exactly. Adapted directly from the
 * Amortization Calculator's own AmortizationLineChart.jsx (identical
 * chart on the same reference site, same 3-series shape). */
export default function InterestRateLineChart({ series, loanAmount, termLabel = "Year" }) {
