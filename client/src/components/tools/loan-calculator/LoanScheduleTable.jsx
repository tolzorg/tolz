...
/** Shared period-by-period schedule table for all three Loan Calculator
 * modes. `columns` is an ordered list of {key, label} pairs pulled from
 * each row object (formatted as currency); "Period" is always the first,
 * unlabeled column. */
export default function LoanScheduleTable({ title, schedule, columns }) {
  return (
